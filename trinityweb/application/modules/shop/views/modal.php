    <div id="newTicket" uk-modal="bg-close: false">
      <div class="uk-modal-dialog">
        ...
        <div class="uk-modal-header">
          <h2 class="uk-modal-title uk-text-uppercase"><i class="fas fa-pencil-alt"></i> <?= $this->lang->line('button_create_ticket'); ?></h2>
        </div>
            ...
            <div class="uk-margin uk-light">
              ...
              <div class="uk-form-controls">
                <div class="uk-width-1-1">
                  <textarea class="uk-textarea tinyeditor" name="" rows="10" cols="80"></textarea>
                </div>
              </div>
            </div>
          </div>
