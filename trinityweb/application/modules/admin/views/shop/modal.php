  ...
  $this->admin_model->insertShop($itemid, $type, $itemname, $pricedp, $pricevp, $iconname, $category, $imagename);
      ...
      <div id="newGroup" uk-modal="bg-close: false">
        <div class="uk-modal-dialog">
          ...
          <div class="uk-modal-header">
            <h3 class="uk-modal-title uk-text-uppercase"><i class="fas fa-object-group"></i> <?= $this->lang->line('form_create_group'); ?></h3>
          </div>
      ...
      <div id="newItem" uk-modal="bg-close: false">
        <div class="uk-modal-dialog">
          <button class="uk-modal-close-default" type="button" uk-close></button>
          <div class="uk-modal-header">
            <h3 class="uk-modal-title uk-text-uppercase"><i class="fas fa-tag"></i> <?= $this->lang->line('form_create_item'); ?></h3>
          </div>
          <form action="" method="post" enctype="multipart/form-data" accept-charset="utf-8" autocomplete="off">
            <div class="uk-modal-body">
              <div class="uk-margin-small">
