      ...
      <div class="uk-modal-dialog">
        ...
        <form action="<?= base_url('forum/newTopic/'.$idlink); ?>" method="post" accept-charset="utf-8" autocomplete="off">
          ...
          <div class="uk-modal-footer uk-text-right actions">
            ...
            <button class="uk-button uk-button-default" type="submit" name="button_createTopic"><?= $this->lang->line('button_create'); ?></button>
          </div>
        </form>
      </div>
    </div>
    ...
    <div id="editTopic" uk-modal="bg-close: false">
      <div class="uk-modal-dialog">
        ...
        <form action="" method="post" accept-charset="utf-8">
          ...
          <div class="uk-modal-footer uk-text-right actions">
            <button class="uk-button uk-button-danger uk-modal-close" type="button"><?= $this->lang->line('button_cancel'); ?></button>
            <button class="uk-button uk-button-default" type="submit" name="button_editTopic"><?= $this->lang->line('button_save'); ?></button>
          </div>
        </form>
      </div>
    </div>
